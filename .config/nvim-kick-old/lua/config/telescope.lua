...
vim.keymap.set('n', '<leader>fs', require('telescope.builtin').builtin, { desc = 'Find [S]elect Telescope' })
...
vim.keymap.set('n', '<leader>fG', ':LiveGrepGitRoot<cr>', { desc = 'Find by [G]rep on Git Root' })
