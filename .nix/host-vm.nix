...
# DHCP or /etc/nixos/local.nix (platform-vm.nix). Spawn it on Proxmox,
# incus, UTM, ... as many times as needed. Prebuilt images come later
# (#32); until then `install.sh iso vm` from the installer ISO, then
